...
<div class="full-box page-header">
    <h3 class="text-center roboto-condensed-regular text-uppercase">
        <i class="fas fa-plus fa-fw"></i> &nbsp; Agregar imagen   </h3>
</div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" id="producto_galeria" name="producto_galeria" type="file" />
                            ...
                            <?php if(is_file("./Vista/assets/product/gallery/".$campos_galeria['imagen_nombre'])){ ?>
                                <figure>
                                    <a data-fslightbox="gallery" href="<?php echo SERVERURL; ?>Vista/assets/product/gallery/<?php echo $campos_galeria['imagen_nombre']; ?>">
                                        <img class="img-fluid img-product-info" src="<?php echo SERVERURL; ?>Vista/assets/product/gallery/<?php echo $campos_galeria['imagen_nombre']; ?>" alt="<?php echo $campos['producto_nombre']; ?>">
                                    </a>
                                </figure>
                            <?php }else{ ?>
                                <figure>
                                    <img class="img-fluid img-product-info" src="<?php echo SERVERURL; ?>Vista/assets/product/gallery/default.jpg" alt="<?php echo $campos['producto_nombre']; ?>">
                                </figure>
                            <?php } ?>
                            <p class="text-center" style="margin-top: 40px;">
