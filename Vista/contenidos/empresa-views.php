...
?>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9-]{8,20}" class="form-control" name="empresa_rif_reg" id="empresa_rif" maxlength="9" >
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="empresa_telefono_reg" id="empresa_telefono" maxlength="11"  >
                                    </div>
                                </div>
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        <label for="empresa_direccion" class="bmd-label-floating">Dirección</label>
                                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="empresa_direccion_reg" id="empresa_direccion" maxlength="50"  >
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php
            }elseif($datos_empresa->rowCount()==1 && ($_SESSION['privilegio_Ser']==1 || $_SESSION['privilegio_Ser']==2 )){
                ...
                <fieldset>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="empresa_rif" class="bmd-label-floating">Rif </label>
                                        <input type="text" pattern="[0-9-]{8,20}" class="form-control" name="empresa_rif_up" id="empresa_rif" maxlength="9" value="<?php echo $campos['empresa_rif']; ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="empresa_telefono" class="bmd-label-floating">Telefono</label>
                                        <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="empresa_telefono_up" id="empresa_telefono" maxlength="11"  value="<?php echo $campos['empresa_telefono']; ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-12">
                                    <div class="form-group">
                                        <label for="empresa_direccion" class="bmd-label-floating">Dirección</label>
                                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="empresa_direccion_up" id="empresa_direccion" maxlength="50"  value="<?php echo $campos['empresa_direccion']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
