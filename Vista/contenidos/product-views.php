...
<div class="bg-white full-box">
    <div class="container container-web-page">
        ...
        <?php }else{ ?>
        <h3 class="font-weight-bold poppins-regular text-center">Productos en tienda</h3>
        ...
        <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; 0">
            <div class="row align-items-center">
                <div class="col-12 col-sm-4 text-center text-sm-start">
                    <div class="dropdown">
                        <button class="btn btn-raised btn-info" type="button" id="categorySubMenu" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="col-12 col-sm-4 text-center">
                    <button type="button" class="btn btn-raised btn-info" data-mdb-toggle="modal" data-mdb-target="#saucerModal">
                        <i class="fas fa-search fa-fw"></i> &nbsp; Buscar
                    </button>
                </div>
                <div class="col-12 col-sm-4 text-center text-sm-end">
                    <div class="dropdown">
                        <button class="btn btn-raised btn-info" type="button" id="OrderSubMenu" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="container-fluid" style="padding: 20px 0;" >
            <div class="row">
                <div class="col-12 col-md-12"  style="left:30%;">
                ...
                <div class="col-12 col-md-12">							
                    <form class="mb-4 FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" data-form="search"  method="POST">
                        ...
                        <button type="submit" class="btn btn-raised btn-danger"  style="left:83%;">
        ...
        <?php
            ...
            echo $Lc->cliente_paginador_producto_controlador($pagina[3],3,$pagina[0],$pagina[2],$pagina[1],$_SESSION['busqueda_tienda']);
        ?>
    </div>
</div>
...
<div class="modal fade" id="saucerModal" tabindex="-1" aria-hidden="true" aria-labelledby="saucerModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" data-form="default"  method="POST" autocomplete="off">
            <input type="hidden" name="modulo" value="tienda">
            ...
            <div class="form-group">
                <button type="button" class="btn btn-raised btn-danger" data-mdb-dismiss="modal"><i class="fas fa-times fa-fw"></i> &nbsp; Cerrar</button>
                <button type="submit" class="btn btn-raised btn-info"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar</button>
            </div>
            </div>
